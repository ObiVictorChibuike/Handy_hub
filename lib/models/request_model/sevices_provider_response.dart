...
//
//     final serviceProviderResponse = serviceProviderResponseFromJson(jsonString);

import 'dart:convert';

ServiceProviderResponse serviceProviderResponseFromJson(String str) => ServiceProviderResponse.fromJson(json.decode(str));

String serviceProviderResponseToJson(ServiceProviderResponse data) => json.encode(data.toJson());
...
class ServiceProviderResponse {
  ...
  factory ServiceProviderResponse.fromJson(Map<String, dynamic> json) => ServiceProviderResponse(
