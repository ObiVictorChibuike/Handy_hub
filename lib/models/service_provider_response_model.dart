...
class ServiceProviderResponseModel {
  ...
  factory ServiceProviderResponseModel.fromJson(Map<String, dynamic> json) => ServiceProviderResponseModel(
...
class ServiceProvider {
  ...
  factory ServiceProvider.fromJson(Map<String, dynamic> json) => ServiceProvider(
    ...
    images: json["images"],
    businessPhoto: json["businessPhoto"] == null ? [] : List<dynamic>.from(json["businessPhoto"]!.map((x) => x)),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "updatedOn": updatedOn,
    "images": images,
    "businessPhoto": businessPhoto == null ? [] : List<dynamic>.from(businessPhoto!.map((x) => x)),
  };
}
