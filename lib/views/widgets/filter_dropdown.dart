...
class FilterDropDownTextField extends StatefulWidget {
  ...
  const FilterDropDownTextField({Key? key, this.items, this.title, this.onChanged}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField2(
      ...
      buttonStyleData: ButtonStyleData(height: 50, padding: const EdgeInsets.only(left: 0, right: 10),
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(5), border: Border.all(color: Colors.white, width: 0.7))),
