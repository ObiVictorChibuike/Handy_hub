...
class StoreVendorRegistration extends StatefulWidget {
  StoreVendorRegistration({Key? key}) : super(key: key);

  @override
  State<StoreVendorRegistration> createState() => _StoreVendorRegistrationState();
}

class _StoreVendorRegistrationState extends State<StoreVendorRegistration> {
  ...
  Widget build(BuildContext context) {
    registrationBloc.addCustomerID(3);
