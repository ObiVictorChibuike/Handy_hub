...
class DeliveryPayWithCardPayment{
  ...
  DeliveryPayWithCardPayment(this.encryptionKey, this.publicKey, this.amount, this.email, this.phoneNumber, this.fullName, this.context);
  ...
  chargeCard() async {
    ...
    try{
      ...
      if (response.success!) {
        ctrl.cardCheckOut(txRef: response.txRef!, context: context, amount: int.parse(amount));
